  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div />
        <form onSubmit={handleSubmit} className="space-y-4 ta">
          {["title", "author", "published_year", "isbn", "price"].map(
            (field) => (
              <div key={field}>
                <label className="block font-medium text-white-700 capitalize">
                  {field.replace("_", " ")}
                </label>
                <input
                  type={
                    field === "price" || field === "published_year"
                      ? "number"
                      : "text"
                  }
                  name={field}
